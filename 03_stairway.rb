...
def mario
  ...
  while bas_escalier != 10
    number = rand(1..6)
    if number == 5 || number == 6
      bas_escalier += 1
      puts "Tu avances d'une marche :). Tu es à la #{bas_escalier} marche."
      print ("\n")
    elsif number == 1
      bas_escalier -= 1
      puts "Tu descends d'une marche :(. Tu es à la #{bas_escalier} marche."
      print ("\n")
    else number == 2 || number == 3 || number == 4
      puts "Tu ne bouges pas :|. Tu es à la #{bas_escalier} marche."
      print ("\n")
    end
  end
...
def average_finish_time(total_die_roll)
...
def perform
  total_die_roll = average_finish_time(total_die_roll)
